...
rule FromRawToCis:
    ...
    shell:
        "Rscript CisTopic.R {threads} {params.string} {input.CpG} {input.coords} {input.premeta} {output.pdfpdf} {output.methTable2GZ} {output.topicAssigToPatientOut} {output.RegScrPrtopicOut} {output.RegAssigUnormalOut} {output.ctoOut} {output.binaOut}"
